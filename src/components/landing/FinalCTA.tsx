    ...
    <section className="py-20 bg-gradient-to-br from-sage-500 via-sage-600 to-sage-700 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="inline-flex items-center gap-2 bg-white/15 rounded-full px-4 py-1.5 mb-6">
          ...
          <span className="text-sm text-white/90 font-medium">100% free, no sign-up</span>
        </div>

        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
          Your Diet Plan Is 5 Minutes Away
        </h2>

        <p className="text-lg text-sage-100 mb-10 max-w-xl mx-auto">
          50,000+ people already have their plan. Only ingredients from your local market.
          Simple recipes your whole family can eat.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/consult"
            className="inline-flex items-center justify-center gap-2 bg-white text-sage-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-sage-50 transition-all hover:shadow-xl hover:-translate-y-0.5"
          >
            Get My Free Plan
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#20bd5a] transition-all hover:shadow-xl hover:-translate-y-0.5"
          >
        ...
        <p className="text-sm text-sage-200 mt-6">
          No credit card &bull; No app download &bull; Works on any phone
        </p>
      </div>
    </section>
  );
